...
class FitnessDescriptionScreen extends StatelessWidget {
  ...
  const FitnessDescriptionScreen({Key key, this.FitnessModel}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  AppBar(
        backgroundColor: Theme.of(context).backgroundColor,
        elevation: 0,
        title: Text('Edit Fitness', style: TextStyle(
                   ...
                   Column(
                     children: <Widget>[
                       Row(
                         ...
                         children: <Widget>[
                           Text(
                             'Start - ${localizations.formatShortDate(
                       startDate)}',
                             style: TextStyle(
                                 fontSize: Config.xMargin(context, 5)),
                           ),
